class ActivityController:
    async def register_activity(self, student_id: str, activity_name: str) -> str:
        ...
        if confirm:
            activity_id = await self.activity_repo.register_activity(student_id, activity_name)
    ...
    async def unregister_activity(self, student_id: str, activity_name: str) -> str:
        ...
        if confirm:
            result = await self.activity_repo.unregister_activity(student_id, activity_name)
            if result:
